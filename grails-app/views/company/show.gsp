	...
	<body>
		...
		<div id="show-company" class="content scaffold-show" role="main">
			...
			<ol class="property-list company">
				...
				<li class="fieldcontain">
					<span id="employees-label" class="property-label"><g:message code="company.employees.label" default="Employees" /></span>
					
						<span class="property-value" aria-labelledby="employees-label"><g:link controller="employee" action="show" id="${companyInstance?.employees?.id}">${companyInstance?.employees?.encodeAsHTML()}</g:link></span>
